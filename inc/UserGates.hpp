...
#define DECL_SYSCALL0(fn,r) r syscall_##fn()
#define DECL_SYSCALL1(fn,r,p1) r syscall_##fn(p1)
#define DECL_SYSCALL2(fn,r,p1,p2) r syscall_##fn(p1,p2)
#define DECL_SYSCALL3(fn,r,p1,p2,p3) r syscall_##fn(p1,p2,p3)
...
#define DEFN_SYSCALL3(fn, num, r, P1, P2, P3) \
    r syscall_##fn(P1 p1, P2 p2, P3 p3) { \
        u32 a = 0; \
...
#define DEFN_SYSCALL4(fn, num, r, P1, P2, P3, P4) \
    r syscall_##fn(P1 p1, P2 p2, P3 p3, P4 p4) { \
        u32 a = 0; \
...
#define DEFN_SYSCALL5(fn, num, r, P1, P2, P3, P4, P5) \
    r syscall_##fn(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) { \
        u32 a = 0; \
